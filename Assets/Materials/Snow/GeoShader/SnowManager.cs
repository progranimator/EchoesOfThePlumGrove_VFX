...
{
    [ExecuteInEditMode] public class SnowManager : MonoBehaviour 
    {
    ...
    */
        ...
        void OnEnable () {
            gridHandler = GetComponent<CameraGrid>();
...
// to trigger rebuilding of the render mesh
    ...
    public class SnowManagerEditor : Editor {
        ...
        public override void OnInspectorGUI() {
            ...
            if (GUILayout.Button("Rebuild Snow Mesh")) {
                (target as SnowManager).RebuildSnowMesh();
